        ...
        <div class="row">
            <div class="col-lg-8">
                <ul class="job-list-item align-items-center">
                    <li>
                        <a href="#">Số lượng <span>(17)</span></a>
                        <a class="rss" href="#">
                            <i class="bx bx-rss"></i>Dữ liệu
                        </a>
                    </li>
                    <li>
...
<option>Potato</option>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Los Angeles, CS, USA
                            </li>
                            <li>5 months ago</li>
                        </ul>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Houston, TX, USA
                            </li>
                            <li>4 months ago</li>
                        </ul>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Ho Chi Minh City, Vietnam
                            </li>
                            <li>6 months ago</li>
                        </ul>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Cardiss, UK
                            </li>
                            <li>9 months ago</li>
                        </ul>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Adelaide SA, Australia
                            </li>
                            <li>10 months ago</li>
                        </ul>
                        <p>We are Looking for a skilled Ul/UX designer amet conscu adiing elitsed do eusmod tempor</p>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Warangal, Telangana, India
                            </li>
                            <li>2 months ago</li>
                        </ul>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Delhi, India
                            </li>
                            <li>5 months ago</li>
                        </ul>
                        <p>Wind Power Engineering Manager amet conscu adiing elitsed do eusmod tempor</p>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Washington, USA
                            </li>
                            <li>4 months ago</li>
                        </ul>
                        <p>Responsible for managing skilled Ul/UX designer amet conscu adiing elitsed do eusmod</p>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Barmingham, UK
                            </li>
                            <li>6 months ago</li>
                        </ul>
                        <p>International collaborative a skilled Ul/UX designer amet conscu adiing elitsed do eusmod</p>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Saudi Arabia
                            </li>
                            <li>9 months ago</li>
                        </ul>
                        <p>International collaborative designer amet conscu adiing elitsed do eusmod tempor</p>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Australia
                            </li>
                            <li>10 months ago</li>
                        </ul>
                        <p>We are Looking for a skilled Ul/UX designer amet conscu adiing elitsed do eusmod tempor</p>
                ...
                <div class="employer-item">
                    <a href="job-details.html">
                        ...
                        <ul>
                            <li>
                                <i class="flaticon-send"></i> Estonia
                            </li>
                            <li>2 months ago</li>
                        </ul>
                        <p>Wind Power Engineering Manager amet conscu adiing elitsed do eusmod tempor</p>
...
Others (1)
                    ...
                    <div class="jecto-contact">
                        <img data-cfsrc="assets/img/jecto-conatct.png" alt="Jecto" style="display:none;visibility:hidden;"><noscript><img src="assets/img/jecto-conatct.png" alt="Jecto"></noscript>
                        <div class="bottom">
