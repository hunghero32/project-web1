            ...
            <div class="d-table-cell">
                <div class="container">
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="left">
                                <img data-cfsrc="assets/img/home-one/job3.png" alt="Details"
                                    style="display:none;visibility:hidden;"><noscript><img
                                        src="assets/img/home-one/job3.png" alt="Details"></noscript>
                                <h2><?= $corp['name'] ?></h2>
                                <ul>
                                    <li>
                        ...
                        <div class="col-lg-4">
                            <div class="right">
                                ...
                                <!-- <ul>
                                    <li>
                                        <a href="#">
                                            <i class="bx bx-heart"></i> Theo dõi
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                        ...
                        <div class="details-inner">
                            ...
                            <div class="job-details-slider owl-theme owl-carousel">
                                <div class="slider-item">
                                    <img data-cfsrc="assets/img/job-details1.jpg" alt="Details"
                                        style="display:none;visibility:hidden;"><noscript><img
                                            src="assets/img/job-details1.jpg" alt="Details"></noscript>
                                </div>
                                <div class="slider-item">
                                    <img data-cfsrc="assets/img/job-details2.jpg" alt="Details"
                                        style="display:none;visibility:hidden;"><noscript><img
                                            src="assets/img/job-details2.jpg" alt="Details"></noscript>
                                </div>
                                <!-- <div class="slider-item">
                ...
                <div class="col-lg-4">
                    <div class="widget-area">
                        <div class="information widget-item">
                            ...
                            <ul>
                                <li>
                                    <img data-cfsrc="assets/img/job-details-icon.png" alt="Details"
                                        style="display:none;visibility:hidden;"><noscript><img
                                            src="assets/img/job-details-icon.png" alt="Details"></noscript>
                                    <h4>Email</h4>
