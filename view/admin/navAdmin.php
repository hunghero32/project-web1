    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" index.php ">
                <!-- <img src="assets/img/logo-three.png" class="navbar-brand-img h-100" alt="main_logo"> -->
                <span class="ms-1 font-weight-bold">Trang Chủ</span>
            </a>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="index.php?act=listcorp">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Doanh Nghiệp</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                ...
                <div class="card-body text-start p-3 w-100">
                    ...
                    <div class="docs-info">
                        <h6 class="text-white up mb-0">Bài Tuyển Dụng</h6>
                        <!-- <p class="text-xs font-weight-bold">Please check our docs</p> -->
                        <a href="index.php?act=listrecr" class="btn btn-white btn-sm w-100 mb-0">Xem Ngay</a>
                    </div>
                </div>
            </div>
